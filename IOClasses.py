...
# NFenske, 2022-Mar-27, Completed TODOS: accept file names and load track data
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        # method to accept a list of file names.
        ...
        try:
            ...
            # code to save track data to file
