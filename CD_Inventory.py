...
# NFenske, 2022-Mar-27, Completed TODOS: added code to handle individual tracks
#------------------------------------------#
...
while True:
    ...
    if strChoice == 'l':
        ...
        # added code to handle tracks on an individual CD
        while True:
            ...
            if strChoice == 'a':
                ...
                IO.ScreenIO.show_tracks(cd)
                str_track_index = input('Select the Track index to remove: ')
                try:
                    track_index = int(str_track_index) 
                except ValueError:
                    print("This is not an integer! Try again or type \'x\' to return to the menu.")  
                continue
